...
&#10003; **Topics** for articles.
&#10003; **Likes** on posts, including the liker.
&#10003; **Comments** on posts, including the content, the user who wrote it, and the timestamp.
&#10003; Notion of **following** users.
&#10003; **Activity logs**, to keep track of likes, comments, and follows, including the performer of activity, what (post) or whom (user) the target of the activity is, and the timestamp.
...
&#10003; Viewing all posts or posts of a certain user.
&#10003; Multiple comments per posts.
&#10003; Liking and unliking posts, and viewing all liked posts in one place.
&#10003; Following and unfollowing users and viewing posts of followed users of a certain user.
&#10003; Associating multiple topics per post and viewing all posts of / searching posts by topics.
&#10003; Finding out updates for each users, kind of like notifications, for example when someone comments on their article, when a followed user posts, etc.
...
*`name`, which is the name of the topic as `TEXT`.
...
The current database design aims to cover the basic most important features of an article publishing site. However, it does not cover all the features that a real world article publishing site may have, such as the ones mentioned as out of scope in the scope section and not supported in the functional requirements section.
